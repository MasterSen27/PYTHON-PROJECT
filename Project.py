...
path='C:/IEMPythonProjects_main-folder'
print('-'*50)
...
def percent(num):
    if stream.lower()=='cse' or stream.lower()=='cseai' or stream.lower()=='cseaiml' or stream.lower()=='cseiotcsbs' or stream.lower()=='it' or stream.lower()=='ece' or stream.lower()=='me':
        num=(num*100)//600
    return num
...
def grade(num):
    if num>=90:
        ...
        return("You performed well in the exam... You have passed the exam with grade C.")
    elif num<70 and num>=60:
        return("Your performance is average... You have passed the exam with grade D.")
    elif num<60 and num>=50:
        return("Your performance is below average... You have barely passed the exam with grade E.")
    else:
...
def get_batch():
    with open(f'C:/IEMPythonProjects_main-folder/Batch.csv','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:/IEMPythonProjects_main-folder/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
